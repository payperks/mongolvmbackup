...
_WARNING:_ Mongolvmbackup is to be used entirely at your own risk.  That said it's believed to be safe and we do use it on real production hosts.  

_WARNING:_ This is pre-1.0 quality.  See the Todo section.

_WARNING:_ An untested backup system is worse than none at all.  Periodically test your backups. 
...
## FAQ
* Why the name? - Because a long-popular tool for backing up MySQL using LVM is called 'mylvmbackup' - it seemed logical for the MongoDB equivalent to follow the same scheme.
